...
alienColor = makeColor 0 100 80 1
...
menuText = Tekst {myID = "menu", myIntID = 0, x = -300, y = 100, string = "Asteroids! Choose a level", size = 0.3, colour = textColor}
...
initialState = GameState {state = Menu, objects = [player, scoreText, pauseText, livesText, menuText, lvl1, lvl2, lvl3], elapsedTime = 0, cntrls = Input{left = False, right = False, forward = False, backward = False}, lives = 3, score = 0, level = 1}
